...
<figure>
  <BlurImage
    src={blobUrl('blog-assets/first-time.jpg')}
    alt="First time holding her in my arms"
    hash="LXM$;@v0VuIV%NvynNo~.7NbIUt6"
    width={1600}
    height={2000}
  />
